...
export const fetchActors = () => {
  return (dispatch, getState) => {
    ...
    return axios.get("http://localhost:5002/api/Actors", {
      headers: {
...
export const editActor = (id, actorData) => {
  return (dispatch, getState) => {
    ...
    return axios.put(`http://localhost:5002/api/Actors/${id}`, actorData, {
      headers: {
        'Authorization': `Bearer ${token}`,
        'Site-Type': sysRole || 'default',
        'Content-Type': 'application/json'
...
export const fetchActorDetails = (id) => {
  return (dispatch) => {
    return axios.get(`http://localhost:5002/api/Actors/${id}`)
      .then(response => {
...
export const addActor = (actorData) => {
  return (dispatch, getState) => {
    ...
    return axios.post("http://localhost:5002/api/Actors", actorData, {
      headers: {
        'Authorization': `Bearer ${token}`,
        'Site-Type': sysRole || 'default',
        'Content-Type': 'application/json'
...
export const hiddenActor = (id) => {
  return (dispatch, getState) => {
    ...
    return axios.put(`http://localhost:5002/api/Actors/Hide/${id}`, {}, {
      headers: {
        'Authorization': `Bearer ${token}`,
        'Site-Type': sysRole || 'default',
        'Content-Type': 'application/json',
